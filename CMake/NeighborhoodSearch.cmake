...
if(USE_GPU_NEIGHBORHOOD_SEARCH)
	...
	ExternalProject_Add(
	   ...
	   CMAKE_ARGS
		 ...
		 -DCMAKE_INSTALL_PREFIX:PATH=${ExternalInstallDir}/NeighborhoodSearch
		 -DCUNSEARCH_USE_DOUBLE_PRECISION:BOOL=${USE_DOUBLE_PRECISION}
		 -DBUILD_DEMO:BOOL=OFF
		 -DCUNSEARCH_INSTALL_CUH:BOOL=ON
	   )
